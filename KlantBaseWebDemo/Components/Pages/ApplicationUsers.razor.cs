...
namespace KlantBaseWebDemo.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<KlantBaseWebDemo.Models.ApplicationUser> users;
        protected RadzenDataGrid<KlantBaseWebDemo.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(KlantBaseWebDemo.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(KlantBaseWebDemo.Models.ApplicationUser user)
        {
            try
            {
